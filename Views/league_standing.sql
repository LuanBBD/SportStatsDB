...
AS 
SELECT dbo.League.league_id, dbo.League.league_name, dbo.Player.player_name, dbo.Team.team_name, dbo.Player_league_stats.goals, dbo.Player_league_stats.yellow_cards, dbo.Player_league_stats.red_cards, 
